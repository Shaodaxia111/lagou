    ...
    constructor(props) {
        ...
        this.state = {
            ...
            promotion: {
                title: "U-Cloud X 拉勾：HelloWorld 我是传奇",
                content: [
                    "/src/img/case-detail-pro1.png"
                    , "2月29日，拉勾网“10万个OFFER-全民升职季”活动正式上线，超过65万人次互联网人通过拉勾网进行简历投递，刷新了互联网招聘行业数据新高。"
                    , "/src/img/case-detail-pro2.jpg"
                    , "/src/img/case-detail-pro3.png"
            ...
            month: {
                ...
                content: [
                    "2015拉勾网年度招聘活动，定位年底求职大军；以全新的游戏型特色模块，展示互联网实力版图；吸引流量的同时，满足企业招聘需求！"
                    , "/src/img/case-detail-mou1.png"
                    , "/src/img/case-detail-mou2.png"
                    , "/src/img/case-detail-mou3.png"
                    , "/src/img/case-detail-mou4.png"
                    , "/src/img/case-detail-mou5.png"
                    , "/src/img/case-detail-mou5.png"
                    , "/src/img/case-detail-mou6.png"
                    , "/src/img/case-detail-mou7.png"
                    , "/src/img/case-detail-mou8.png"
                    , "/src/img/case-detail-mou9.png"
                ]
            }
        }
    }
