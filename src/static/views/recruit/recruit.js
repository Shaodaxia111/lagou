    ...
    return (
      <div className="recruit-content">
        <div className="recruit-banner">
          ...
          <p className="operate-tit">发展历程：</p>
          ...
          <p className="operate-tit">公司基本信息：</p>
